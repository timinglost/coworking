...
questions = [
    ...
    {
        "category": "Арендодателям",
        "name": "Как стать арендодателем?",
        "slug": "kak-stat-arendodatelem",
        "text": "Для того, чтобы стать арендодателем, вам необходимо получить этот статус. "
                "Статус выдается администратором после рассмотрения заявки. Создать заявку вы можете сразу при регистрации, "
                "выбрав тип аккаунта \"Арендодатель\" или из Личного Кабинета, выбрав \"Стать арендодателем\" и заполнив форму."
    },
    {
        "category": "Арендодателям",
        "name": "Как разместить объявление?",
        "slug": "kak-razmestit-objavlenie",
        "text": "Размещать объявления могут пользователи, со статусом \"Арендодатель\". "
                "Чтобы узнать, как его получить, откройте соответствующий вопрос в F.A.Q."
                "После получения этого статуса, на главной странице появится кнопка Предложить помещение. "
                "Там вам необходимо заполнить все указанные поля и ваше объявление отправится на модерацию. "
                "После прохождения модерации оно появится в каталоге и другие пользователи смогут его просмотреть."
    },
    {
        "category": "Пользователям",
        "name": "Как найти подходящее объявление?",
        "slug": "kak-naiti-podhodyashee-objavlenie",
        "text": "Для того, чтобы найти подходящее место для коворкинга, "
                "вы можете воспользоваться нашим поисковиком в каталоге. "
                "Для того, чтобы попасть в Каталог, в строке поиска на главной странице укажите необходимый город и "
                "нажмите \"Найти\". Попав в каталог, вы можете воспользоваться дополнительными фильтрами. "
                "Найдя подходящее объявление, вы можете перейти в это объявление и оформить заявку на бронирование."
    },
    {
        "category": "Пользователям",
        "name": "Как оформить заявку на бронирование?",
        "slug": "kak-oformit-zayavku-na-bronirovanie",
        "text": "Для оформление заявки на бронирование необходимо перейти на страницу объявления и заполнить форму. "
                "В этой форме вам необходимо заполнить поля \"Начало аренды\", \"Конец аренды\". После этого необходимо"
                " указать необходимое вам кол-во мест. После этого откроется список доступных периодов, которые "
                "максимально приближены к вашему запросу. После выбора периода, необходимо указать сколько мест будет "
                "указано в заявке и нажать \"Принять\"."
    },
    {
        "category": "Пользователям",
        "name": "Как оставить отзыв?",
        "slug": "kak-ostavit-otziv",
        "text": "Оставить отзыв вы можете из Личного Кабинета. В разделе \"Мои бронирования\" во вкладке "
                "\"Текущие заказы\" будут перечислены ваши активные заявки, которые вы можете в любой момент закрыть и "
                "оставить отзыв. Выбрав \"Закрыть и оставить отзыв\" вы попадете на страницу создания отзыва. "
                "Выставите там оценки, и напишите свое впечатление, которые максимально отражают действительную "
                "обстановку, чтобы помочь в улучшении качества предоставляемых услуг. После публикации, ваш отзыв можно"
                " найти на странице объявления."
    },
]
...
room_categories = [{'name': 'Открытое место'}, {'name': 'Офис'}, {'name': 'Приватный офис'},
                   {'name': 'Зал для конференций'}, {'name': 'Видео-студия'}, ]
